...
class Form extends Component {
  ...
  handleChange = ({ currentTarget: input }) => {
    ...
    data[input.name] = input.value; //assign data dynamically using [], independently instead of using . 
  ...
  handleSubmit = (e) => {
    ...
    // we should return error, if no errors, we should return { },cause we cant return null
